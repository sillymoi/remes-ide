 ...
 * <ul>
 *   <li>{@link hr.fer.rasip.remes.grammars.expressions.ast.impl.ActionRootImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActionRootImpl extends AbstractRootImpl implements ActionRoot {
	...
	protected EClass eStaticClass() {
		return AstPackage.Literals.ACTION_ROOT;
	}
	...
	public EList<Expression> getExpressions() {
		if (expressions == null) {
			expressions = new EObjectContainmentEList<Expression>(Expression.class, this, AstPackage.ACTION_ROOT__EXPRESSIONS);
		}
		return expressions;
	}
