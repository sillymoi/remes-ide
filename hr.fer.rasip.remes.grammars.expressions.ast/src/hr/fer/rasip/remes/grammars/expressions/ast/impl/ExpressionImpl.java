 ...
 * <ul>
 *   <li>{@link hr.fer.rasip.remes.grammars.expressions.ast.impl.ExpressionImpl#getType <em>Type</em>}</li>
 *   <li>{@link hr.fer.rasip.remes.grammars.expressions.ast.impl.ExpressionImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ExpressionImpl extends EObjectImpl implements Expression {
	...
	public void setType(ResolvedType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AstPackage.EXPRESSION__TYPE, oldType, type, !oldTypeESet));
	}
	...
	public void unsetType() {
		...
		typeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AstPackage.EXPRESSION__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
	}
	...
	public void setText(String newText) {
		...
		text = newText;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AstPackage.EXPRESSION__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AstPackage.EXPRESSION__TYPE:
				return getType();
			case AstPackage.EXPRESSION__TEXT:
				return getText();
		}
