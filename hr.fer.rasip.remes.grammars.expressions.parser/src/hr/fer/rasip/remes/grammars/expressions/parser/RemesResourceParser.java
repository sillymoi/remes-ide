// $ANTLR 3.2 Sep 23, 2009 12:02:23 D:\\Dokumenti\\Faks\\PhD\\galileo\\hr.fer.rasip.remes.grammars.expressions.parser\\grammar\\RemesResource.g 2010-02-26 10:42:54
...
public class RemesResourceParser extends Parser {
    ...
    // D:\\Dokumenti\\Faks\\PhD\\galileo\\hr.fer.rasip.remes.grammars.expressions.parser\\grammar\\RemesResource.g:39:1: constant : ( NAT | FLOAT );
    public final RemesResourceParser.constant_return constant() throws RecognitionException {
        ...
        try {
            // D:\\Dokumenti\\Faks\\PhD\\galileo\\hr.fer.rasip.remes.grammars.expressions.parser\\grammar\\RemesResource.g:40:3: ( NAT | FLOAT )
            // D:\\Dokumenti\\Faks\\PhD\\galileo\\hr.fer.rasip.remes.grammars.expressions.parser\\grammar\\RemesResource.g:
            {
            root_0 = (Object)adaptor.nil();
    ...
    public static final BitSet FOLLOW_IS_in_resource_expression74 = new BitSet(new long[]{0x0000018000C00000L});
    ...
    public static final BitSet FOLLOW_PLUS_in_sign_expression109 = new BitSet(new long[]{0x0000018000C00000L});
    public static final BitSet FOLLOW_sign_expression_in_sign_expression111 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_MINUS_in_sign_expression128 = new BitSet(new long[]{0x0000018000C00000L});
