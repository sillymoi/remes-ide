 ...
 * <ul>
 *   <li>{@link hr.fer.rasip.remes.gum.behaviour.impl.ReferableImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ReferableImpl extends EObjectImpl implements Referable {
	...
	protected EClass eStaticClass() {
		return BehaviourPackage.Literals.REFERABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviourPackage.REFERABLE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BehaviourPackage.REFERABLE__NAME:
				return getName();
		}
