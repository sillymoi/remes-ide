...
public class BehaviourSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BehaviourPackage.BEHAVIOUR: {
				...
				if (result == null) result = caseContext(behaviour);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviourPackage.CONTEXT: {
				Context context = (Context)theEObject;
				T result = caseContext(context);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviourPackage.MODE: {
				Mode mode = (Mode)theEObject;
				T result = caseMode(mode);
				if (result == null) result = caseContext(mode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviourPackage.COMPOSITE_MODE: {
				...
				if (result == null) result = caseContext(compositeMode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviourPackage.ATOMIC_MODE: {
				AtomicMode atomicMode = (AtomicMode)theEObject;
				T result = caseAtomicMode(atomicMode);
				if (result == null) result = caseMode(atomicMode);
				if (result == null) result = caseContext(atomicMode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviourPackage.REFERABLE: {
			...
			case BehaviourPackage.RESOURCE: {
			...
			case BehaviourPackage.CONSTANT: {
			...
			case BehaviourPackage.EDGE: {
				Edge edge = (Edge)theEObject;
				T result = caseEdge(edge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviourPackage.INIT_EDGE: {
				InitEdge initEdge = (InitEdge)theEObject;
				T result = caseInitEdge(initEdge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviourPackage.RENAMING: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Atomic Mode</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Atomic Mode</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAtomicMode(AtomicMode object) {
		return null;
	}
