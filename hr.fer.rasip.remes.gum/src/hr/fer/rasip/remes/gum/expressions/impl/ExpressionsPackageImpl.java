...
import hr.fer.rasip.remes.gum.expressions.Constant;
import hr.fer.rasip.remes.gum.expressions.Expression;
import hr.fer.rasip.remes.gum.expressions.ExpressionsFactory;
import hr.fer.rasip.remes.gum.expressions.ExpressionsPackage;
import hr.fer.rasip.remes.gum.expressions.Literal;
...
public class ExpressionsPackageImpl extends EPackageImpl implements ExpressionsPackage {
	 ...
	 * @see hr.fer.rasip.remes.gum.expressions.ExpressionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getVariableReference_Resolved(), theBehaviourPackage.getReferable(), null, "resolved", null, 1, 1, VariableReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
