...
public class ProfileFactoryImpl extends EFactoryImpl implements ProfileFactory {
	...
	public static ProfileFactory init() {
		try {
			ProfileFactory theProfileFactory = (ProfileFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.rasip.fer.hr/gum/0.1.0/profile.ecore"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ProfilePackage.CONSTANT_VALUE: return createConstantValue();
