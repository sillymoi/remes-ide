 ...
 * <ul>
 *   <li>{@link hr.fer.rasip.remes.gum.structure.impl.ConnectorImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ConnectorImpl extends StructureElementImpl implements Connector {
	/**
	 ...
	 * @ordered
	 */
	protected static final ConnectorType TYPE_EDEFAULT = ConnectorType.CONTROL_OR;
	...
	public void setType(ConnectorType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.CONNECTOR__TYPE, oldType, type));
	}
