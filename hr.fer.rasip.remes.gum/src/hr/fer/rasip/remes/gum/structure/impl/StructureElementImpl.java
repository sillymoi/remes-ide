 ...
 * <ul>
 *   <li>{@link hr.fer.rasip.remes.gum.structure.impl.StructureElementImpl#getParent <em>Parent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class StructureElementImpl extends InterfaceImpl implements StructureElement {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public Composite getParent() {
		if (eContainerFeatureID() != StructurePackage.STRUCTURE_ELEMENT__PARENT) return null;
	...
	public NotificationChain basicSetParent(Composite newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, StructurePackage.STRUCTURE_ELEMENT__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(Composite newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StructurePackage.STRUCTURE_ELEMENT__PARENT && newParent != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.STRUCTURE_ELEMENT__PARENT, newParent, newParent));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructurePackage.STRUCTURE_ELEMENT__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
