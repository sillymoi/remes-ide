...
public class StructureSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StructurePackage.BEHAVER: {
				Behaver behaver = (Behaver)theEObject;
				T result = caseBehaver(behaver);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructurePackage.PRIMITIVE: {
				Primitive primitive = (Primitive)theEObject;
				T result = casePrimitive(primitive);
				if (result == null) result = caseBehaver(primitive);
				if (result == null) result = caseStructureElement(primitive);
				if (result == null) result = caseInterface(primitive);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructurePackage.COMPOSITE: {
				Composite composite = (Composite)theEObject;
				T result = caseComposite(composite);
				if (result == null) result = caseBehaver(composite);
				if (result == null) result = caseStructureElement(composite);
				if (result == null) result = caseInterface(composite);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructurePackage.PORT: {
				Port port = (Port)theEObject;
				T result = casePort(port);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructurePackage.DATA_PORT: {
			...
			case StructurePackage.MESSAGE_PORT: {
			...
			case StructurePackage.TRIGGER_PORT: {
			...
			case StructurePackage.CONNECTION: {
			...
			case StructurePackage.CONNECTOR: {
				...
				if (result == null) result = caseStructureElement(connector);
				if (result == null) result = caseInterface(connector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructurePackage.PORT_GROUP: {
				PortGroup portGroup = (PortGroup)theEObject;
				T result = casePortGroup(portGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructurePackage.INTERFACE: {
			...
			case StructurePackage.STRUCTURE_ELEMENT: {
				...
				if (result == null) result = caseInterface(structureElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Behaver</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Behaver</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBehaver(Behaver object) {
		return null;
	}
