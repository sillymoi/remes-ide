...
//
public interface IRemessrcReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends hr.fer.rasip.remes.resource.remessrc.IRemessrcConfigurable {
	...
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, hr.fer.rasip.remes.resource.remessrc.IRemessrcReferenceResolveResult<ReferenceType> result);
