...
public class RemessrcDefaultResolverDelegate<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> {
	...
	protected void resolve(java.lang.String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, hr.fer.rasip.remes.resource.remessrc.IRemessrcReferenceResolveResult<ReferenceType> result) {
		try {
	...
	private boolean checkElement(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EClass type, java.lang.String identifier, boolean resolveFuzzy, hr.fer.rasip.remes.resource.remessrc.IRemessrcReferenceResolveResult<ReferenceType> result) {
		if (element.eIsProxy()) {
			return true;
		}
	...
	protected java.lang.String produceDeResolveErrorMessage(org.eclipse.emf.ecore.EObject refObject, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, hr.fer.rasip.remes.resource.remessrc.IRemessrcTextResource resource) {
		...
		if (nameAttr instanceof org.eclipse.emf.ecore.EAttribute) {
			...
			for (org.eclipse.emf.ecore.EOperation o : element.eClass().getEAllOperations()) {
				if (o.getName().toLowerCase().endsWith(NAME_FEATURE) && o.getEParameters().size() == 0 ) {
					java.lang.String result = (java.lang.String) hr.fer.rasip.remes.resource.remessrc.util.RemessrcEObjectUtil.invokeOperation(element, o);
	...
	private java.lang.String getName(ReferenceType element) {
		...
		if(element.eIsProxy()) {
			...
			if (fragment != null && fragment.startsWith(hr.fer.rasip.remes.resource.remessrc.IRemessrcContextDependentURIFragment.INTERNAL_URI_FRAGMENT_PREFIX)) {
				fragment = fragment.substring(hr.fer.rasip.remes.resource.remessrc.IRemessrcContextDependentURIFragment.INTERNAL_URI_FRAGMENT_PREFIX.length());
