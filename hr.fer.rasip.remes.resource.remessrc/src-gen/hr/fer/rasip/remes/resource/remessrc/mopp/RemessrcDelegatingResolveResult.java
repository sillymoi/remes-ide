...
//
public class RemessrcDelegatingResolveResult<ReferenceType> implements hr.fer.rasip.remes.resource.remessrc.IRemessrcReferenceResolveResult<ReferenceType> {
	
	private hr.fer.rasip.remes.resource.remessrc.IRemessrcReferenceResolveResult<ReferenceType> delegate;
	
	public RemessrcDelegatingResolveResult(hr.fer.rasip.remes.resource.remessrc.IRemessrcReferenceResolveResult<ReferenceType> delegate) {
