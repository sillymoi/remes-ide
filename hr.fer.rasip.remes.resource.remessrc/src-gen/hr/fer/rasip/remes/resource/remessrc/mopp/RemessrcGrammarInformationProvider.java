...
public class RemessrcGrammarInformationProvider {
	...
	public final static LineBreak ELEMENT_1 = new LineBreak(1);
	public final static Keyword ELEMENT_2 = new Keyword("{");
	...
	public final static Keyword ELEMENT_136 = new Keyword("[");
	public final static Placeholder ELEMENT_137 = new Placeholder(se.mdh.progresside.remes.RemesPackage.eINSTANCE.getVariable().getEStructuralFeature(se.mdh.progresside.remes.RemesPackage.VARIABLE__VECTOR_SIZE));
	public final static Keyword ELEMENT_138 = new Keyword("]");
	public final static Sequence ELEMENT_139 = new Sequence(ELEMENT_136, ELEMENT_137, ELEMENT_138);
	public final static Choice ELEMENT_140 = new Choice(ELEMENT_139);
	public final static Compound ELEMENT_141 = new Compound(ELEMENT_140);
	public final static Placeholder ELEMENT_142 = new Placeholder(se.mdh.progresside.remes.RemesPackage.eINSTANCE.getVariable().getEStructuralFeature(se.mdh.progresside.remes.RemesPackage.VARIABLE__NAME));
	public final static Keyword ELEMENT_143 = new Keyword("=");
	public final static Placeholder ELEMENT_144 = new Placeholder(se.mdh.progresside.remes.RemesPackage.eINSTANCE.getVariable().getEStructuralFeature(se.mdh.progresside.remes.RemesPackage.VARIABLE__VALUE));
	public final static Sequence ELEMENT_145 = new Sequence(ELEMENT_143, ELEMENT_144);
	public final static Choice ELEMENT_146 = new Choice(ELEMENT_145);
	public final static Compound ELEMENT_147 = new Compound(ELEMENT_146);
	public final static Sequence ELEMENT_148 = new Sequence(ELEMENT_122, ELEMENT_126, ELEMENT_130, ELEMENT_134, ELEMENT_135, ELEMENT_141, ELEMENT_142, ELEMENT_147);
	public final static Choice ELEMENT_149 = new Choice(ELEMENT_148);
	public final static Rule ELEMENT_150 = new Rule(se.mdh.progresside.remes.RemesPackage.eINSTANCE.getVariable(), ELEMENT_149);
	public final static Keyword ELEMENT_151 = new Keyword("resource");
	public final static Placeholder ELEMENT_152 = new Placeholder(se.mdh.progresside.remes.RemesPackage.eINSTANCE.getResource().getEStructuralFeature(se.mdh.progresside.remes.RemesPackage.RESOURCE__TYPE));
	public final static Placeholder ELEMENT_153 = new Placeholder(se.mdh.progresside.remes.RemesPackage.eINSTANCE.getResource().getEStructuralFeature(se.mdh.progresside.remes.RemesPackage.RESOURCE__NAME));
	public final static Keyword ELEMENT_154 = new Keyword(":");
	public final static Placeholder ELEMENT_155 = new Placeholder(se.mdh.progresside.remes.RemesPackage.eINSTANCE.getResource().getEStructuralFeature(se.mdh.progresside.remes.RemesPackage.RESOURCE__EXPRESSION));
	public final static Sequence ELEMENT_156 = new Sequence(ELEMENT_154, ELEMENT_155);
	public final static Choice ELEMENT_157 = new Choice(ELEMENT_156);
	public final static Compound ELEMENT_158 = new Compound(ELEMENT_157);
	public final static Sequence ELEMENT_159 = new Sequence(ELEMENT_151, ELEMENT_152, ELEMENT_153, ELEMENT_158);
	public final static Choice ELEMENT_160 = new Choice(ELEMENT_159);
	public final static Rule ELEMENT_161 = new Rule(se.mdh.progresside.remes.RemesPackage.eINSTANCE.getResource(), ELEMENT_160);
	public final static Keyword ELEMENT_162 = new Keyword("const");
	public final static Placeholder ELEMENT_163 = new Placeholder(se.mdh.progresside.remes.RemesPackage.eINSTANCE.getConstant().getEStructuralFeature(se.mdh.progresside.remes.RemesPackage.CONSTANT__GLOBAL));
	public final static Sequence ELEMENT_164 = new Sequence(ELEMENT_163);
	public final static Choice ELEMENT_165 = new Choice(ELEMENT_164);
	public final static Compound ELEMENT_166 = new Compound(ELEMENT_165);
	public final static Placeholder ELEMENT_167 = new Placeholder(se.mdh.progresside.remes.RemesPackage.eINSTANCE.getConstant().getEStructuralFeature(se.mdh.progresside.remes.RemesPackage.CONSTANT__TYPE));
	public final static Placeholder ELEMENT_168 = new Placeholder(se.mdh.progresside.remes.RemesPackage.eINSTANCE.getConstant().getEStructuralFeature(se.mdh.progresside.remes.RemesPackage.CONSTANT__NAME));
	public final static Keyword ELEMENT_169 = new Keyword("=");
	public final static Placeholder ELEMENT_170 = new Placeholder(se.mdh.progresside.remes.RemesPackage.eINSTANCE.getConstant().getEStructuralFeature(se.mdh.progresside.remes.RemesPackage.CONSTANT__VALUE));
	public final static Sequence ELEMENT_171 = new Sequence(ELEMENT_169, ELEMENT_170);
	public final static Choice ELEMENT_172 = new Choice(ELEMENT_171);
	public final static Compound ELEMENT_173 = new Compound(ELEMENT_172);
	public final static Sequence ELEMENT_174 = new Sequence(ELEMENT_162, ELEMENT_166, ELEMENT_167, ELEMENT_168, ELEMENT_173);
	public final static Choice ELEMENT_175 = new Choice(ELEMENT_174);
	public final static Rule ELEMENT_176 = new Rule(se.mdh.progresside.remes.RemesPackage.eINSTANCE.getConstant(), ELEMENT_175);
}
