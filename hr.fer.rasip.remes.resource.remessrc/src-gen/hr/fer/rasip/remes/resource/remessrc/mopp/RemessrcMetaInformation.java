...
public class RemessrcMetaInformation implements hr.fer.rasip.remes.resource.remessrc.IRemessrcMetaInformation {
	...
	public java.lang.String getPathToCSDefinition() {
		return "EMFTextTest/model/remes.cs";
	}
	...
	public org.eclipse.jface.text.rules.ITokenScanner createTokenScanner(hr.fer.rasip.remes.resource.remessrc.ui.RemessrcColorManager colorManager) {
