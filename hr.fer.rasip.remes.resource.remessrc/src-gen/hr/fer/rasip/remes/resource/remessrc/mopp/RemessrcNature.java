...
public class RemessrcNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "hr.fer.rasip.remes.resource.remessrc.nature";
	
	private org.eclipse.core.resources.IProject project;
	
	// the IDs of all builders, IDs of additional builders can be added here
	public final static String[] BUILDER_IDS = {hr.fer.rasip.remes.resource.remessrc.mopp.RemessrcBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(hr.fer.rasip.remes.resource.remessrc.mopp.RemessrcBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
