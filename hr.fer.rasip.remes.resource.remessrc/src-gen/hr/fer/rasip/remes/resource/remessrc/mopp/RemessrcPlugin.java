...
public class RemessrcPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "hr.fer.rasip.remes.resource.remessrc";
	...
	private static RemessrcPlugin plugin;
	
	public RemessrcPlugin() {
		super();
	}
	...
	public static RemessrcPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, RemessrcPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, RemessrcPlugin.PLUGIN_ID, message);
		}
		final RemessrcPlugin pluginInstance = RemessrcPlugin.getDefault();
