...
public class RemessrcBackgroundParsingStrategy {
	...
	// a delay.
	public void parse(org.eclipse.jface.text.DocumentEvent event, final hr.fer.rasip.remes.resource.remessrc.IRemessrcTextResource resource, final hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor editor) {
		if (resource == null) {
			return;
		}
