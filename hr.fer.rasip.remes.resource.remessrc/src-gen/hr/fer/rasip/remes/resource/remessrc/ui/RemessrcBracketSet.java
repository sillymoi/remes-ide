...
public class RemessrcBracketSet {
	...
	private java.util.ArrayList<hr.fer.rasip.remes.resource.remessrc.IRemessrcBracketPair> bracketPairs;
	...
	private class BracketPair implements hr.fer.rasip.remes.resource.remessrc.IRemessrcBracketPair {
	...
	private class ClosingListener implements org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				hr.fer.rasip.remes.resource.remessrc.IRemessrcBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	...
	public RemessrcBracketSet(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String extension) {
		languageID = extension;
		this.bracketPairs = new java.util.ArrayList<hr.fer.rasip.remes.resource.remessrc.IRemessrcBracketPair>();
	...
	public hr.fer.rasip.remes.resource.remessrc.IRemessrcBracketPair getBracketPair(String opening, String closing) {
		for (hr.fer.rasip.remes.resource.remessrc.IRemessrcBracketPair bracketPair : bracketPairs) {
	...
	public hr.fer.rasip.remes.resource.remessrc.IRemessrcBracketPair getBracketPair(int index) {
		try {
	...
	public boolean setClosingEnabledInside(hr.fer.rasip.remes.resource.remessrc.IRemessrcBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	public hr.fer.rasip.remes.resource.remessrc.IRemessrcBracketPair remove(String opening, String closing) {
		for (hr.fer.rasip.remes.resource.remessrc.IRemessrcBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<hr.fer.rasip.remes.resource.remessrc.IRemessrcBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
