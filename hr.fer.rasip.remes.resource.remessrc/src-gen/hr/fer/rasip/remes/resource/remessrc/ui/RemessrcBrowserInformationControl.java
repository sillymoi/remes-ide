...
// @since 3.2
///
public class RemessrcBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private hr.fer.rasip.remes.resource.remessrc.ui.RemessrcDocBrowserInformationControlInput fInput;
	...
	public RemessrcBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	...
	public RemessrcBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	...
	// @since 3.4
	///
	public RemessrcBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof hr.fer.rasip.remes.resource.remessrc.ui.RemessrcDocBrowserInformationControlInput);
		...
		fInput= (hr.fer.rasip.remes.resource.remessrc.ui.RemessrcDocBrowserInformationControlInput) input;
		...
		hr.fer.rasip.remes.resource.remessrc.ui.RemessrcHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = hr.fer.rasip.remes.resource.remessrc.ui.RemessrcHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	...
	///
	public hr.fer.rasip.remes.resource.remessrc.ui.RemessrcDocBrowserInformationControlInput getInput() {
		return fInput;
	}
