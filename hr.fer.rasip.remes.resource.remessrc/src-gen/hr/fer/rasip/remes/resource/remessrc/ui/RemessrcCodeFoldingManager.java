...
public class RemessrcCodeFoldingManager {
	
	private class FoldingUpdateListener implements hr.fer.rasip.remes.resource.remessrc.IRemessrcBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor) {
				hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor editor = (hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor) workbenchPart;
	...
	protected hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor editor;
	...
	public RemessrcCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor textEditor) {
	...
	private void addCloseListener(final hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			hr.fer.rasip.remes.resource.remessrc.mopp.RemessrcPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		hr.fer.rasip.remes.resource.remessrc.IRemessrcTextResource textResource = (hr.fer.rasip.remes.resource.remessrc.IRemessrcTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
