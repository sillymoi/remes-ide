...
public class RemessrcHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionHelper positionHelper = new hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionHelper();
	private boolean isHighlightBrackets = true;
	private boolean isHighlightOccurrences = true;
	private hr.fer.rasip.remes.resource.remessrc.ui.RemessrcTokenScanner scanner;
	...
	private hr.fer.rasip.remes.resource.remessrc.ui.RemessrcOccurrence occurrence;
	private hr.fer.rasip.remes.resource.remessrc.ui.RemessrcBracketSet bracketSet;
	...
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, hr.fer.rasip.remes.resource.remessrc.IRemessrcBackgroundParsingListener {
	...
	public RemessrcHighlighting(hr.fer.rasip.remes.resource.remessrc.IRemessrcTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcColorManager colorManager, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = hr.fer.rasip.remes.resource.remessrc.mopp.RemessrcPlugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new hr.fer.rasip.remes.resource.remessrc.ui.RemessrcTokenScanner(colorManager);
		occurrence = new hr.fer.rasip.remes.resource.remessrc.ui.RemessrcOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new hr.fer.rasip.remes.resource.remessrc.ui.RemessrcBracketSet(sourceviewer, "remessrc");
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		isHighlightOccurrences = preferenceStore.getBoolean(hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		definitionColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_DEFINITION_COLOR));
		proxyColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_PROXY_COLOR));
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor editor) {
	...
	private void setHighlighting() {
		...
		if (occurrence.isPositionsChanged()) {
			...
			hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionCategory.DEFINTION.toString());
			setCategoryHighlighting(document,
			hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionCategory.PROXY.toString());
		}
		setCategoryHighlighting(document, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionCategory.BRACKET.toString());
	}
	...
	private void setCategoryHighlighting(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionCategory.PROXY.toString())) {
		...
		for (org.eclipse.jface.text.Position position : positions) {
			...
			if (tmpPosition != null) {
				if (category.equals(hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionCategory.DEFINTION.toString())) {
				...
				if (category.equals(hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionCategory.BRACKET.toString())) {
					styleRange = getStyleRangeAtPosition(tmpPosition);
	...
	private void removeHighlighting() {
		org.eclipse.jface.text.IDocument document = projectionViewer.getDocument();
		removeHighlightingCategory(document, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionCategory.BRACKET.toString());
		if (occurrence.isToRemoveHighlighting()) {
			removeHighlightingCategory(document, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionCategory.DEFINTION.toString());
			removeHighlightingCategory(document, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionCategory.PROXY.toString());
			lastStyleRange = null;
		}
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, category);
		boolean isOccurrence = (category.equals(hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionCategory.DEFINTION.toString()) || category.equals(hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionCategory.PROXY.toString())) && lastStyleRange != null;
		if (category.equals(hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty()) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof hr.fer.rasip.remes.resource.remessrc.IRemessrcTextResource) {
