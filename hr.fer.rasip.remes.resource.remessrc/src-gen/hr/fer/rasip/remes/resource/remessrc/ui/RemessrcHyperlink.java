...
public class RemessrcHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	...
	public RemessrcHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor) {
					hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor emftEditor = (hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor) editorPart;
