...
public class RemessrcNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private hr.fer.rasip.remes.resource.remessrc.ui.RemessrcNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public RemessrcNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new hr.fer.rasip.remes.resource.remessrc.ui.RemessrcNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			hr.fer.rasip.remes.resource.remessrc.mopp.RemessrcPlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			hr.fer.rasip.remes.resource.remessrc.mopp.RemessrcPlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new hr.fer.rasip.remes.resource.remessrc.mopp.RemessrcMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public java.lang.String getFileExtension() {
		return new hr.fer.rasip.remes.resource.remessrc.mopp.RemessrcMetaInformation().getSyntaxName();
	}
