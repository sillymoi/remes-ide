...
// </ul>
//
public class RemessrcOccurrencePreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private void initializeValues() {
		boolean enable = getPreferenceStore().getBoolean(hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		enableCheckbox.setSelection(enable);
		
		defColorButton.setEnabled(enable);
		org.eclipse.swt.graphics.RGB rgb = org.eclipse.jface.preference.PreferenceConverter.getColor(getPreferenceStore(), hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_DEFINITION_COLOR);
		defColorSelector.setColorValue(rgb);
		
		useColorButton.setEnabled(enable);
		rgb = org.eclipse.jface.preference.PreferenceConverter.getColor(getPreferenceStore(), hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_PROXY_COLOR);
		useColorSelector.setColorValue(rgb);
	}
	
	// Set the default values for this preference page.
	protected void performDefaults() {
		boolean enable = getPreferenceStore().getDefaultBoolean(hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		enableCheckbox.setSelection(enable);
		defColorButton.setEnabled(enable);
		useColorButton.setEnabled(enable);
		defColorSelector.setColorValue(org.eclipse.jface.preference.PreferenceConverter.getDefaultColor(getPreferenceStore(), hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_DEFINITION_COLOR));
		useColorSelector.setColorValue(org.eclipse.jface.preference.PreferenceConverter.getDefaultColor(getPreferenceStore(), hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_PROXY_COLOR));
	}
	...
	private void updateActiveEditor() {
		getPreferenceStore().setValue(hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX, enableCheckbox.getSelection());
		org.eclipse.jface.preference.PreferenceConverter.setValue(getPreferenceStore(), hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_DEFINITION_COLOR, defColorSelector.getColorValue());
		org.eclipse.jface.preference.PreferenceConverter.setValue(getPreferenceStore(), hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPreferenceConstants.EDITOR_PROXY_COLOR, useColorSelector.getColorValue());
