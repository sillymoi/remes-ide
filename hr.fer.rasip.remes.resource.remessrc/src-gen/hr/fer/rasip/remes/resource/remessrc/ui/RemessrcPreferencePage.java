...
//
public class RemessrcPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(hr.fer.rasip.remes.resource.remessrc.mopp.RemessrcPlugin.getDefault().getPreferenceStore());
		setDescription(" Remessrc Text Editor Preferences");
	}
