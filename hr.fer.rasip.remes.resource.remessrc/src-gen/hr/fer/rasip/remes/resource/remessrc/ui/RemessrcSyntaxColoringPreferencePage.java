...
///
public class RemessrcSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = hr.fer.rasip.remes.resource.remessrc.ui.RemessrcSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = hr.fer.rasip.remes.resource.remessrc.ui.RemessrcSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = hr.fer.rasip.remes.resource.remessrc.ui.RemessrcSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = hr.fer.rasip.remes.resource.remessrc.ui.RemessrcSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = hr.fer.rasip.remes.resource.remessrc.ui.RemessrcSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = hr.fer.rasip.remes.resource.remessrc.ui.RemessrcSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hr.fer.rasip.remes.resource.remessrc.ui.RemessrcSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPixelConverter pixelConverter = new hr.fer.rasip.remes.resource.remessrc.ui.RemessrcPixelConverter(composite);
	...
	public RemessrcSyntaxColoringPreferencePage() {
		super();
		
		hr.fer.rasip.remes.resource.remessrc.IRemessrcMetaInformation syntaxPlugin = new hr.fer.rasip.remes.resource.remessrc.mopp.RemessrcMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor) {
			hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor emfTextEditor = (hr.fer.rasip.remes.resource.remessrc.ui.RemessrcEditor) editor;
