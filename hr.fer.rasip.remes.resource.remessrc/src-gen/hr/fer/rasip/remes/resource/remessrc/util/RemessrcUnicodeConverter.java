...
// bytes).
//
public class RemessrcUnicodeConverter extends hr.fer.rasip.remes.resource.remessrc.mopp.RemessrcInputStreamProcessor {
	...
	public RemessrcUnicodeConverter(java.io.InputStream inputStream) {
