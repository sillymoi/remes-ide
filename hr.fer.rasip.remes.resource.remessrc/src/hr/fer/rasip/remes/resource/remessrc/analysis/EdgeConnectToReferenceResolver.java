...
public class EdgeConnectToReferenceResolver implements hr.fer.rasip.remes.resource.remessrc.IRemessrcReferenceResolver<se.mdh.progresside.remes.Edge, se.mdh.progresside.remes.EntryPoint> {
	
	private hr.fer.rasip.remes.resource.remessrc.analysis.RemessrcDefaultResolverDelegate<se.mdh.progresside.remes.Edge, se.mdh.progresside.remes.EntryPoint> delegate = new hr.fer.rasip.remes.resource.remessrc.analysis.RemessrcDefaultResolverDelegate<se.mdh.progresside.remes.Edge, se.mdh.progresside.remes.EntryPoint>();
		
	public java.lang.String deResolve(se.mdh.progresside.remes.EntryPoint element, se.mdh.progresside.remes.Edge container, org.eclipse.emf.ecore.EReference reference) {
	...
	public void resolve(java.lang.String identifier, se.mdh.progresside.remes.Edge container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final hr.fer.rasip.remes.resource.remessrc.IRemessrcReferenceResolveResult<se.mdh.progresside.remes.EntryPoint> result) {
			try {
	...
	private boolean checkElement(EObject element, se.mdh.progresside.remes.Edge container, String identifier, boolean resolveFuzzy, hr.fer.rasip.remes.resource.remessrc.IRemessrcReferenceResolveResult<se.mdh.progresside.remes.EntryPoint> result) {
			if (element.eIsProxy()) {
				return true;
			}
			...
			if(ctrl.getName().equals(identifier)) {
				if(ctrl instanceof CompositeMode) {
					...
					if(granny.eContainer() == ctrl) {
						...
						if(cm.getCompositeExitPoint() == null) {
							//System.out.println("Creating missing comp exit point for edge");
				...
				if(ctrl.getEntryPoint() == null) {
					...
					//System.out.println("Creating missing entry point for edge");
