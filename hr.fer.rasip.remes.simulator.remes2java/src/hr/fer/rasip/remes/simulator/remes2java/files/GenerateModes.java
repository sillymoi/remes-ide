...
/**
 * Entry point of the 'GenerateModes' generation module.
 *
 * @generated
 */
public class GenerateModes extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/hr/fer/rasip/remes/simulator/remes2java/files/generateModes";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "generateMode" };
  ...
  /**
	 ...
	 * @generated
	 */
	public GenerateModes(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GenerateModes(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateModes generator = new GenerateModes(modelURI, folder, arguments);
