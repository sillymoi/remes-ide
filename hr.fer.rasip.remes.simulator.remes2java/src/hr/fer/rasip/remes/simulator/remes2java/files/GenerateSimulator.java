...
import hr.fer.rasip.remes.simulator.remes2java.util.Util;
...
/**
 * Entry point of the 'GenerateSimulator' generation module.
 *
 * @generated
 */
public class GenerateSimulator extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/hr/fer/rasip/remes/simulator/remes2java/files/generateSimulator";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "generateSimulator" };
  ...
  /**
	 ...
	 * @generated
	 */
	public GenerateSimulator(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GenerateSimulator(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateSimulator generator = new GenerateSimulator(modelURI, folder, arguments);
