 ...
 * @since 1.0.2
 */
public class MojXYZDataset extends AbstractXYZDataset
    ...
    public double getX2Value(int series, int item) {
        double[][] seriesData = (double[][]) this.seriesList.get(series);
    ...
    public double getY2Value(int series, int item) {
        double[][] seriesData = (double[][]) this.seriesList.get(series);
    ...
    /// vraca isto sto i x2 ; zastarjelo od DeafaultXYZDataset
    ...
    public void addSeries(Comparable seriesKey, double[][] data) {
        ...
        if (data.length != 4) {
            throw new IllegalArgumentException(
                    "The 'data' array must have length == 4.");
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MojXYZDataset)) {
            return false;
        }
        MojXYZDataset that = (MojXYZDataset) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
    	MojXYZDataset clone = (MojXYZDataset) super.clone();
