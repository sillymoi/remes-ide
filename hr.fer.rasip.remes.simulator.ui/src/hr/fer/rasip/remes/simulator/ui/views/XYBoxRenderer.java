 ...
 */
public class XYBoxRenderer extends AbstractXYItemRenderer implements XYItemRenderer, PublicCloneable {

    /** For serialization. */
	private static final long serialVersionUID = -2164305611932557396L;
     ...
     */
    public XYBoxRenderer(int scaleType) {
        super();
    ...
    public void drawItem(Graphics2D g2, XYItemRendererState state,
        ...
        if (dataset instanceof DefaultIntervalXYDataset) {
        	DefaultIntervalXYDataset xyzData = (DefaultIntervalXYDataset) dataset;
        	x1 =(Double) xyzData.getStartXValue(series, item);
            y1 =(Double) xyzData.getStartYValue(series, item);
            x2 =(Double) xyzData.getEndXValue(series, item);
            y2 =(Double) xyzData.getEndYValue(series, item);
            
            x=x1; // NAREDBA RECTANGLE CRTA OD GORNJEG LIJEVOG KUTA
            y=y2;
        ...
        if (!Double.isNaN(z)) {
         ...
         //  }
            ...
            Rectangle2D pravokutnik=null;
     
            
            double faktorSirine=dataArea.getWidth()/dataArea.getHeight()*rangeAxis.getUpperBound()/domainAxis.getUpperBound();
            
    
            pravokutnik = new Rectangle2D.Double(transX,
                    transY, transDomain*faktorSirine*sirina, transRange*visina);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof XYBoxRenderer)) {
            return false;
        }
        XYBoxRenderer that = (XYBoxRenderer) obj;
