...
/**
 * This is the item provider adapter for a {@link hr.fer.rasip.uppaal.LocationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LocationType_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LocationType_color_feature", "_UI_LocationType_type"),
				 UppaalPackage.Literals.LOCATION_TYPE__COLOR,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UppaalPackage.Literals.LOCATION_TYPE__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_LocationType_x_feature", "_UI_LocationType_type"),
				 UppaalPackage.Literals.LOCATION_TYPE__X,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_LocationType_y_feature", "_UI_LocationType_type"),
				 UppaalPackage.Literals.LOCATION_TYPE__Y,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UppaalPackage.Literals.LOCATION_TYPE__NAME);
			childrenFeatures.add(UppaalPackage.Literals.LOCATION_TYPE__LABEL);
			childrenFeatures.add(UppaalPackage.Literals.LOCATION_TYPE__URGENT);
			childrenFeatures.add(UppaalPackage.Literals.LOCATION_TYPE__COMMITTED);
		}
	...
	public String getText(Object object) {
		String label = ((LocationType)object).getId();
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UppaalPackage.Literals.LOCATION_TYPE__NAME,
				 UppaalFactory.eINSTANCE.createNameType()));

		newChildDescriptors.add
			(createChildParameter
				(UppaalPackage.Literals.LOCATION_TYPE__LABEL,
				 UppaalFactory.eINSTANCE.createLabelType()));

		newChildDescriptors.add
			(createChildParameter
				(UppaalPackage.Literals.LOCATION_TYPE__URGENT,
				 UppaalFactory.eINSTANCE.createUrgentType()));

		newChildDescriptors.add
			(createChildParameter
				(UppaalPackage.Literals.LOCATION_TYPE__COMMITTED,
