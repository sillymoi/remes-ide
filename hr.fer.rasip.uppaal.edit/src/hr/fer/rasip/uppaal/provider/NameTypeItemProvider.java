...
/**
 * This is the item provider adapter for a {@link hr.fer.rasip.uppaal.NameType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NameTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NameType_x_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NameType_x_feature", "_UI_NameType_type"),
				 UppaalPackage.Literals.NAME_TYPE__X,
				 true,
				 false,
				 false,
	...
	protected void addYPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NameType_y_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NameType_y_feature", "_UI_NameType_type"),
				 UppaalPackage.Literals.NAME_TYPE__Y,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UppaalPackage.Literals.NAME_TYPE__MIXED);
		}
	...
	public String getText(Object object) {
		Object labelValue = ((NameType)object).getX();
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UppaalPackage.Literals.NAME_TYPE__MIXED,
