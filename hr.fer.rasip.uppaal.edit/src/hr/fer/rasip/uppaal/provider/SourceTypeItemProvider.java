...
/**
 * This is the item provider adapter for a {@link hr.fer.rasip.uppaal.SourceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SourceTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SourceType_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SourceType_ref_feature", "_UI_SourceType_type"),
				 UppaalPackage.Literals.SOURCE_TYPE__REF,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((SourceType)object).getRef();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SourceType.class)) {
			case UppaalPackage.SOURCE_TYPE__REF:
