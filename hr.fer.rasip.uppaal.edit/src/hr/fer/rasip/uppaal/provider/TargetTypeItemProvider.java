...
/**
 * This is the item provider adapter for a {@link hr.fer.rasip.uppaal.TargetType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TargetTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TargetType_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TargetType_ref_feature", "_UI_TargetType_type"),
				 UppaalPackage.Literals.TARGET_TYPE__REF,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((TargetType)object).getRef();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TargetType.class)) {
			case UppaalPackage.TARGET_TYPE__REF:
