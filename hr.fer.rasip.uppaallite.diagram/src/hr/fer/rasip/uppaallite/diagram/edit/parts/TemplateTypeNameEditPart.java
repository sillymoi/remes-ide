 ...
 * @generated
 */
public class TemplateTypeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TemplateTypeNameEditPart(View view) {
		super(view);
	}
			...
			parser = UppaalliteParserProvider
					.getParser(
							...
							UppaalliteVisualIDRegistry
									.getType(hr.fer.rasip.uppaallite.diagram.edit.parts.TemplateTypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
