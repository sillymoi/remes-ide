 ...
 * @generated
 */
public class UppaalliteDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public UppaalliteDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof UppaalliteDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier
							.getChildren(((UppaalliteDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new UppaalliteDomainNavigatorItem(
