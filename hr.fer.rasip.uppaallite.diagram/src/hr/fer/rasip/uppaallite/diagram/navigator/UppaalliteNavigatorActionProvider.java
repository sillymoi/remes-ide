...
import hr.fer.rasip.uppaallite.diagram.part.Messages;
import hr.fer.rasip.uppaallite.diagram.part.UppaalliteDiagramEditor;
 ...
 * @generated
 */
public class UppaalliteNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof UppaalliteNavigatorItem) {
					selectedElement = ((UppaalliteNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, UppaalliteDiagramEditor.ID);
