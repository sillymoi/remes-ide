...
public class UppaalliteElementTypes extends ElementInitializers {
	 ...
	 * @generated
	 */
	public static final IElementType UppaalDiagram_1000 = getElementType("hr.fer.rasip.uppaallite.diagram.UppaalDiagram_1000"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType TemplateType_2001 = getElementType("hr.fer.rasip.uppaallite.diagram.TemplateType_2001"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(UppaalDiagram_1000, UppaallitePackage.eINSTANCE
					.getUppaalDiagram());

			elements.put(TemplateType_2001, UppaallitePackage.eINSTANCE
					.getTemplateType());
		}
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(UppaalDiagram_1000);
			KNOWN_ELEMENT_TYPES.add(TemplateType_2001);
		}
	...
	public static IElementType getElementType(int visualID) {
		...
		case UppaalDiagramEditPart.VISUAL_ID:
			return UppaalDiagram_1000;
		case TemplateTypeEditPart.VISUAL_ID:
			return TemplateType_2001;
		}
		return null;
	}
