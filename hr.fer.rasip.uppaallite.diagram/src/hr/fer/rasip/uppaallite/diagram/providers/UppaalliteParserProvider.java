...
public class UppaalliteParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private IParser templateTypeName_5001Parser;

	/**
	 * @generated
	 */
	private IParser getTemplateTypeName_5001Parser() {
		if (templateTypeName_5001Parser == null) {
			EAttribute[] features = new EAttribute[] { UppaallitePackage.eINSTANCE
					.getTemplateType_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			templateTypeName_5001Parser = parser;
		}
		return templateTypeName_5001Parser;
	}
	...
	protected IParser getParser(int visualID) {
		switch (visualID) {
		case TemplateTypeNameEditPart.VISUAL_ID:
			return getTemplateTypeName_5001Parser();
		}
		return null;
	}
