...
public class UppaalliteViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return UppaalDiagramEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!UppaalDiagramEditPart.MODEL_ID
		...
		return TemplateTypeEditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(UppaalDiagramEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case TemplateTypeEditPart.VISUAL_ID:
			return createTemplateType_2001(domainElement, containerView, index,
	 ...
	 * @generated
	 */
	public Node createTemplateType_2001(EObject domainElement,
	...
	private void stampShortcut(View containerView, Node target) {
		if (!UppaalDiagramEditPart.MODEL_ID.equals(UppaalliteVisualIDRegistry
				.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE
					.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
					"modelID", UppaalDiagramEditPart.MODEL_ID); //$NON-NLS-1$
