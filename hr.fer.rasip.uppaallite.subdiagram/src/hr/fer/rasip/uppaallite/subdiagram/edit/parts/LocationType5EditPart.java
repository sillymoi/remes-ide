...
import hr.fer.rasip.uppaallite.subdiagram.edit.policies.LocationType5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LocationType5EditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public LocationType5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LocationType5ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		LocationTypeInitUrgentFigure figure = new LocationTypeInitUrgentFigure();
	 ...
	 * @generated
	 */
	public LocationTypeInitUrgentFigure getPrimaryShape() {
		return (LocationTypeInitUrgentFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof LocationTypeName5EditPart
				|| borderItemEditPart instanceof LocationTypeInvariant5EditPart) {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof hr.fer.rasip.uppaallite.subdiagram.edit.parts.LocationType5EditPart) {
			types.add(UppaalliteElementTypes.TransitionType_4002);
		}
	 ...
	 * @generated
	 */
	public class LocationTypeInitUrgentFigure extends Ellipse {

		/**
		 * @generated
		 */
		public LocationTypeInitUrgentFigure() {
			this.setLineWidth(2);
		...
		private void createContents() {
			...
			elli0.setLineWidth(0);
			elli0.setForegroundColor(ColorConstants.black);
			elli0.setBackgroundColor(ColorConstants.black);
			elli0.setLocation(new Point(getMapMode().DPtoLP(11), getMapMode()
					.DPtoLP(12)));
			elli0.setSize(getMapMode().DPtoLP(10), getMapMode().DPtoLP(10));
