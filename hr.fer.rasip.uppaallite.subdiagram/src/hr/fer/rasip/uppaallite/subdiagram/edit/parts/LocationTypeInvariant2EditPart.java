...
import hr.fer.rasip.uppaallite.subdiagram.edit.policies.UppaalliteTextSelectionEditPolicy;
 ...
 * @generated
 */
public class LocationTypeInvariant2EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				UppaalliteVisualIDRegistry
						.getType(hr.fer.rasip.uppaallite.subdiagram.edit.parts.LocationTypeInvariant2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public LocationTypeInvariant2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new UppaalliteTextSelectionEditPolicy());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof UppaalliteTextSelectionEditPolicy) {
			((UppaalliteTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof UppaalliteTextSelectionEditPolicy) {
			((UppaalliteTextSelectionEditPolicy) sfEditPolicy)
					.refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), UppaalliteEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new LocationInvariantFigure();
	}

	/**
	 * @generated
	 */
	public class LocationInvariantFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public LocationInvariantFigure() {
			this.setText("");
