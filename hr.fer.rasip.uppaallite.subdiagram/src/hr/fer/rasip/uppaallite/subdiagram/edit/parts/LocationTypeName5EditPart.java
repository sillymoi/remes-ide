 ...
 * @generated
 */
public class LocationTypeName5EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				UppaalliteVisualIDRegistry
						.getType(hr.fer.rasip.uppaallite.subdiagram.edit.parts.LocationTypeName5EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public LocationTypeName5EditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new LocationNameFigure();
	}

	/**
	 * @generated
	 */
	public class LocationNameFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public LocationNameFigure() {
			this.setText("");
