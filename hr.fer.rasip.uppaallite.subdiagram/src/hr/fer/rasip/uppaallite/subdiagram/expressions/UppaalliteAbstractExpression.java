 ...
 * @generated
 */
public abstract class UppaalliteAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = UppaalliteDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected UppaalliteAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
