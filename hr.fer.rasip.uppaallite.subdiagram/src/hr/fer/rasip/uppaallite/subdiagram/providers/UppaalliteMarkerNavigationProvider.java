...
import hr.fer.rasip.uppaallite.subdiagram.part.UppaalliteDiagramEditorUtil;
 ...
 * @generated
 */
public class UppaalliteMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = UppaalliteDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			UppaalliteDiagramEditorUtil.selectElementsInDiagram(editor, Arrays
