...
import hr.fer.rasip.uppaallite.subdiagram.part.UppaalliteDiagramEditor;
 ...
 * @generated
 */
public class UppaalliteValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = UppaalliteDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof UppaalliteDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& TemplateTypeEditPart.MODEL_ID
						.equals(UppaalliteVisualIDRegistry.getModelID(view));
	}
