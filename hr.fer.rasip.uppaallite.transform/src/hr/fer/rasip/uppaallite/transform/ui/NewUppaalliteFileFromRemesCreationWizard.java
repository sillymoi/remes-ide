...
public class NewUppaalliteFileFromRemesCreationWizard extends Wizard{
	...
	public NewUppaalliteFileFromRemesCreationWizard(IFile sourceFile){
		assert sourceFile != null : "Source file must be specified"; //$NON-NLS-1$
		
		myFileCreationPage = new WizardNewFileCreationPage("Remes to Uppaallite transformation Wizard", StructuredSelection.EMPTY);
		myFileCreationPage.setTitle("Uppaallite File");
		myFileCreationPage.setDescription("Create new Uppaallite file based on Remes model");
