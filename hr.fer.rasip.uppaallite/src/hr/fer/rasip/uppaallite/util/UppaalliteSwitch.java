 ...
 * @generated
 */
public class UppaalliteSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UppaallitePackage.UPPAAL_DIAGRAM: {
				UppaalDiagram uppaalDiagram = (UppaalDiagram)theEObject;
				T result = caseUppaalDiagram(uppaalDiagram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UppaallitePackage.TEMPLATE_TYPE: {
				TemplateType templateType = (TemplateType)theEObject;
				T result = caseTemplateType(templateType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UppaallitePackage.LOCATION_TYPE: {
				LocationType locationType = (LocationType)theEObject;
				T result = caseLocationType(locationType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UppaallitePackage.TRANSITION_TYPE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Uppaal Diagram</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Uppaal Diagram</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUppaalDiagram(UppaalDiagram object) {
		return null;
	}
