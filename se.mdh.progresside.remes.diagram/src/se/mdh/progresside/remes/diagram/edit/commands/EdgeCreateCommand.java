...
public class EdgeCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final ExitPoint container;
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof ExitPoint) {
			return false;
		}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Edge newElement = RemesFactory.eINSTANCE.createEdge();
		getContainer().getExitEdges().add(newElement);
	 ...
	 * @generated
	 */
	protected ExitPoint getSource() {
		return (ExitPoint) source;
	}
	 ...
	 * @generated
	 */
	private static ExitPoint deduceContainer(EObject source, EObject target) {
