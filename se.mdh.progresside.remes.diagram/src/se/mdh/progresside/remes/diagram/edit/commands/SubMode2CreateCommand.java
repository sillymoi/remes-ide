 ...
 * @generated
 */
public class SubMode2CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public SubMode2CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		SubMode newElement = RemesFactory.eINSTANCE.createSubMode();
		...
		owner.getSubModes().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(SubMode newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
