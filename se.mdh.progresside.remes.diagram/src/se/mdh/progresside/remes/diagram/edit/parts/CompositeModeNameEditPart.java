 ...
 * @generated
 */
public class CompositeModeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CompositeModeNameEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		return RemesDiagramEditorPlugin.findImageDescriptor(
				"icons/compositemode.gif").createImage();
	}
