...
import se.mdh.progresside.remes.diagram.edit.policies.InitPointItemSemanticEditPolicy;
import se.mdh.progresside.remes.diagram.providers.RemesElementTypes;

/**
 * @generated
 */
public class InitPointEditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public InitPointEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InitPointItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		InitPointFigure figure = new InitPointFigure();
	 ...
	 * @generated
	 */
	public InitPointFigure getPrimaryShape() {
		return (InitPointFigure) primaryShape;
	}
