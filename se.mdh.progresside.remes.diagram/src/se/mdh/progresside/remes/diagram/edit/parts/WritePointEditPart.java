...
import se.mdh.progresside.remes.diagram.edit.policies.WritePointItemSemanticEditPolicy;
import se.mdh.progresside.remes.diagram.providers.RemesElementTypes;

/**
 * @generated
 */
public class WritePointEditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public WritePointEditPart(View view) {
		super(view);
	}

	/**
	 * disable deletion from diagram
	 * @generated NOT
	 */
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new WritePointItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		WritePointFigure figure = new WritePointFigure();
	 ...
	 * @generated
	 */
	public WritePointFigure getPrimaryShape() {
		return (WritePointFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class WritePointFigure extends Ellipse {

		/**
		 * @generated
		 */
		public WritePointFigure() {
			this.setLineWidth(1);
