 ...
 * @generated
 */
public abstract class RemesAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = RemesDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected RemesAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
