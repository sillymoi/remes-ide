...
public class LiteralItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Literal_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Literal_text_feature", "_UI_Literal_type"),
				 AstPackage.Literals.LITERAL__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Literal)object).getText();
