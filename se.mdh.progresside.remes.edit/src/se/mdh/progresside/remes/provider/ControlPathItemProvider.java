...
/**
 * This is the item provider adapter for a {@link se.mdh.progresside.remes.ControlPath} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControlPathItemProvider
	 ...
	 * @generated
	 */
	public ControlPathItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ControlPath)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ControlPath_type") :
			getString("_UI_ControlPath_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ControlPath.class)) {
