...
/**
 * This is the item provider adapter for a {@link se.mdh.progresside.remes.Resource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resource_expression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resource_expression_feature", "_UI_Resource_type"),
				 RemesPackage.Literals.RESOURCE__EXPRESSION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RemesPackage.Literals.RESOURCE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RemesPackage.Literals.RESOURCE__PARSED_EXPRESSION);
		}
	...
	public String getText(Object object) {
		...
		String label = res.getExpression();
		String type = res.getType().toString();
		
		return label == null || label.length() == 0 ?
			getString("_UI_Resource_type") :
			getString("_UI_Resource_type") + " " + label + "(" + type + ")";
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RemesPackage.Literals.RESOURCE__PARSED_EXPRESSION,
				 AstFactory.eINSTANCE.createResourceRoot()));
	}
