...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Entry Conditional Sub Edge</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link se.mdh.progresside.remes.impl.EntryConditionalSubEdgeImpl#getConnectTo <em>Connect To</em>}</li>
 *   <li>{@link se.mdh.progresside.remes.impl.EntryConditionalSubEdgeImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link se.mdh.progresside.remes.impl.EntryConditionalSubEdgeImpl#getActionGuard <em>Action Guard</em>}</li>
 *   <li>{@link se.mdh.progresside.remes.impl.EntryConditionalSubEdgeImpl#getActionBody <em>Action Body</em>}</li>
 *   <li>{@link se.mdh.progresside.remes.impl.EntryConditionalSubEdgeImpl#getParsedActionGuard <em>Parsed Action Guard</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EntryConditionalSubEdgeImpl extends FromConditionalConnectorEdgeImpl implements EntryConditionalSubEdge {
	/**
	 ...
	 * @generated
	 */
	protected EntryConditionalSubEdgeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RemesPackage.Literals.ENTRY_CONDITIONAL_SUB_EDGE;
	}
		...
		if (connectTo != null && connectTo.eIsProxy()) {
			...
			if (connectTo != oldConnectTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__CONNECT_TO, oldConnectTo, connectTo));
			}
		}
		return connectTo;
	}
	...
	public NotificationChain basicSetConnectTo(SubMode newConnectTo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__CONNECT_TO, oldConnectTo, newConnectTo);
	...
	public void setConnectTo(SubMode newConnectTo) {
		if (newConnectTo != connectTo) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__CONNECT_TO, newConnectTo, newConnectTo));
	}
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public void setActionGuard(String newActionGuard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__ACTION_GUARD, oldActionGuard, actionGuard));
	}
	...
	public void setActionBody(String newActionBody) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__ACTION_BODY, oldActionBody, actionBody));
	}
	...
	public NotificationChain basicSetParsedActionGuard(LogicalRoot newParsedActionGuard, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__PARSED_ACTION_GUARD, oldParsedActionGuard, newParsedActionGuard);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParsedActionGuard(LogicalRoot newParsedActionGuard) {
		if (newParsedActionGuard != parsedActionGuard) {
			...
			if (parsedActionGuard != null)
				msgs = ((InternalEObject)parsedActionGuard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__PARSED_ACTION_GUARD, null, msgs);
			if (newParsedActionGuard != null)
				msgs = ((InternalEObject)newParsedActionGuard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__PARSED_ACTION_GUARD, null, msgs);
			msgs = basicSetParsedActionGuard(newParsedActionGuard, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__PARSED_ACTION_GUARD, newParsedActionGuard, newParsedActionGuard));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__CONNECT_TO:
				if (connectTo != null)
					msgs = ((InternalEObject)connectTo).eInverseRemove(this, RemesPackage.SUB_MODE__ENTRY_EDGES, SubMode.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__ATTRIBUTES:
				return ((InternalEList<?>)getAttributes()).basicRemove(otherEnd, msgs);
			case RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__PARSED_ACTION_GUARD:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__ACTION_GUARD:
				return getActionGuard();
			case RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__ACTION_BODY:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ToSubModeEdge.class) {
			switch (derivedFeatureID) {
				case RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__CONNECT_TO: return RemesPackage.TO_SUB_MODE_EDGE__CONNECT_TO;
				default: return -1;
			}
		}
		if (baseClass == Attributable.class) {
			switch (derivedFeatureID) {
				case RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__ATTRIBUTES: return AttributesPackage.ATTRIBUTABLE__ATTRIBUTES;
				default: return -1;
			}
		}
		if (baseClass == Edge.class) {
			switch (derivedFeatureID) {
				case RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__ACTION_GUARD: return RemesPackage.EDGE__ACTION_GUARD;
				case RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__ACTION_BODY: return RemesPackage.EDGE__ACTION_BODY;
				case RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__PARSED_ACTION_GUARD: return RemesPackage.EDGE__PARSED_ACTION_GUARD;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ToSubModeEdge.class) {
			switch (baseFeatureID) {
				case RemesPackage.TO_SUB_MODE_EDGE__CONNECT_TO: return RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__CONNECT_TO;
				default: return -1;
			}
		}
		if (baseClass == Attributable.class) {
			switch (baseFeatureID) {
				case AttributesPackage.ATTRIBUTABLE__ATTRIBUTES: return RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__ATTRIBUTES;
				default: return -1;
			}
		}
		if (baseClass == Edge.class) {
			switch (baseFeatureID) {
				case RemesPackage.EDGE__ACTION_GUARD: return RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__ACTION_GUARD;
				case RemesPackage.EDGE__ACTION_BODY: return RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__ACTION_BODY;
				case RemesPackage.EDGE__PARSED_ACTION_GUARD: return RemesPackage.ENTRY_CONDITIONAL_SUB_EDGE__PARSED_ACTION_GUARD;
				default: return -1;
			}
		}
