 ...
 * <ul>
 *   <li>{@link se.mdh.progresside.remes.impl.SubModeImpl#getEntryEdges <em>Entry Edges</em>}</li>
 *   <li>{@link se.mdh.progresside.remes.impl.SubModeImpl#getExitEdges <em>Exit Edges</em>}</li>
...
public class SubModeImpl extends ModeImpl implements SubMode {
	 ...
	 * @ordered
	 */
	protected EList<ToSubModeEdge> entryEdges;
	 ...
	 * @ordered
	 */
	protected EList<FromSubModeEdge> exitEdges;
	 ...
	 * @generated
	 */
	public EList<ToSubModeEdge> getEntryEdges() {
		if (entryEdges == null) {
			entryEdges = new EObjectWithInverseResolvingEList<ToSubModeEdge>(ToSubModeEdge.class, this, RemesPackage.SUB_MODE__ENTRY_EDGES, RemesPackage.TO_SUB_MODE_EDGE__CONNECT_TO);
		}
		return entryEdges;
	}
	 ...
	 * @generated
	 */
	public EList<FromSubModeEdge> getExitEdges() {
		if (exitEdges == null) {
			exitEdges = new EObjectContainmentWithInverseEList<FromSubModeEdge>(FromSubModeEdge.class, this, RemesPackage.SUB_MODE__EXIT_EDGES, RemesPackage.FROM_SUB_MODE_EDGE__CONNECT_FROM);
		}
		return exitEdges;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case RemesPackage.SUB_MODE__ENTRY_EDGES:
				getEntryEdges().clear();
				getEntryEdges().addAll((Collection<? extends ToSubModeEdge>)newValue);
				return;
			case RemesPackage.SUB_MODE__EXIT_EDGES:
				getExitEdges().clear();
				getExitEdges().addAll((Collection<? extends FromSubModeEdge>)newValue);
				return;
			case RemesPackage.SUB_MODE__INVARIANT:
